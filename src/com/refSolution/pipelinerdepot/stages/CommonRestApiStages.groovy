...
class CommonRestApiStages {
    ...
    def getDesirtedStateByName(Map env, Map stageInput = [:]){
        script.stage("getDesirtedStateByName"){
            ...
            String curlCmd = "curl -X GET -H 'Authorization: Bearer $tToken' https://ota.eu.bosch-mobility-cloud.com/api/applications/ota/desiredStates/Test2__AVH_app_test_install"
